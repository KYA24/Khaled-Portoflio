  ...
  try {
    ...
    const card = (achievement) => {
      ...
      return `<div class="achievement-card">
        ${achievement.image ? `<img class="achievement-img" src="${escapeHTML(achievement.image)}" alt="${escapeHTML(t(achievement.imageAlt))}" loading="lazy" onerror="this.hidden=true">` : ""}
